...
# Model cadangan Gemini yang lebih hemat kuota gratis,
# dipakai jika GEMINI_CHAT_MODEL kena rate limit / gagal.
...
def call_gemini(uid, text, task, model=None):
    ...
    use_model = model or GEMINI_CHAT_MODEL
